...
export default function createStaticStylesheet(
  ...
  const theme = Object.entries(srcTheme).reduce(
    (t, [prop, color]) => {
...
const ruleGenerators = [
  ...
  createRuleGen(
    t => t.neutralTextActive,
    t => [`color: ${rgb(mix(t.neutralText, [255, 255, 255], mx.fg.hover))}`],
    s => `${s}:hover`
  ),
  createRuleGen(
    t => t.neutralTextActive,
    t => [`color: ${rgb(mix(t.neutralText, [255, 255, 255], mx.fg.active))}`],
    s => `${s}:active, ${s}:focus`
  ),
  createRuleGen(
    t => t.neutralBorder,
    t => [`border-color: ${rgb(mix(t.neutralBg, t.neutralText, mx.border))}`]
  ),
  ...
  createRuleGen(
    t => t.redBgActive,
    t => [`background-color: ${rgb(mix(t.redBg, [255, 0, 64], mx.bg.hover))}`],
    s => `${s}:hover`
  ),
  createRuleGen(
    t => t.redBgActive,
    t => [`background-color: ${rgb(mix(t.redBg, [255, 0, 64], mx.bg.active))}`],
    s => `${s}:active, ${s}:focus`
  ),
  ...
  createRuleGen(
    t => t.greenTextActive,
    t => [`color: ${rgb(mix(t.greenText, [182, 255, 224], mx.fg.hover))}`],
    s => `${s}:hover`
  ),
  createRuleGen(
    t => t.greenTextActive,
    t => [`color: ${rgb(mix(t.greenText, [182, 255, 224], mx.fg.active))}`],
    s => `${s}:active, ${s}:focus`
  ),
  createRuleGen(
    t => t.greenBorder,
  ...
  createRuleGen(
    t => t.blueTextActive,
    t => [`color: ${rgb(mix(t.blueText, [182, 224, 255], mx.fg.active))}`],
    s => `${s}:active, ${s}:focus`
  ),
  createRuleGen(
    t => t.blueBorder,
